...
class CarEnv:
    ...
    def reset(self):
        ...
        # Iterate through actors and destroy vehicles
    ...
    def step(self, action):
        ...
        # SALIDA UTILIZADA EL RESTO DE PROGRAMAS
            ...
            actor_rotation_roll = actor_t.rotation.roll
            # Set spectator at given transform (vehicle transform)
            spectator.set_transform(carla.Transform(carla.Location(x=actor_location_x, y=actor_location_y, z=actor_location_z+30),
                                                    carla.Rotation(pitch=actor_rotation_pitch-70, yaw=actor_rotation_yaw, roll=actor_rotation_roll)))
